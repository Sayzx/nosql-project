...
# Script optionnel pour initialiser le graphe Neo4j manuellement
# Usage: ./init_db.sh

echo "🔄 Attente du démarrage de Neo4j..."
sleep 10

echo "📊 Initialisation du graphe Neo4j..."

cypher-shell -u neo4j -p password123 -a neo4j://neo4j:7687 << 'EOF'
// Clear existing data
...
echo "✅ Graphe initialisé avec succès!"
